...
//                 {
//                     types::global_dof_index dof_index = cell->vertex_dof_index(vertex_index, comp);

//                     if (comp == 0)
//                     {
//                         if (p.distance(Point<dim>()) < 0.2)
//                             solution_n(dof_index) = 0.1 * std::exp(-20 * p.square());
...
//     std::ifstream input_file("../simulation.msh");
//     Assert(input_file, ExcFileNotOpen("simulation.msh"));

//     grid_in.read_msh(input_file);

//     // もし必要なら material_idの変換やチェックをここで行う
//     // 例: mshのmaterial_idが19,20,21のままで良ければこのままでOK

//     // 確認用出力（任意）
//     // unsigned int cell_index = 0;
//     // for (const auto &cell : triangulation.active_cell_iterators())
//     // {
//     //     std::cout << "Cell " << cell_index << " material_id = " << cell->material_id() << std::endl;
//     //     ++cell_index;
//     // }
